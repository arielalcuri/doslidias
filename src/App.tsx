    ...
    return (
        <div className="w-full">
            ...
            <header className="relative w-full py-12 md:py-32 flex items-center overflow-hidden bg-[#faf7f2] mt-16 md:mt-20">
                {/* Artistic Glows */}
                <div className="absolute top-[-10%] left-[-10%] w-[40%] h-[60%] bg-primary/10 rounded-full blur-[120px] animate-float-slow" />
                <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[70%] bg-secondary/10 rounded-full blur-[150px] animate-float-slow" style={{ animationDelay: '-5s' }} />
            ...
            <section className="py-24 bg-white relative overflow-hidden border-b border-slate-50">
                <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-12 text-center relative z-10">
                    <div className="flex flex-col items-center group">
                        <div className="w-20 h-20 bg-primary/10 rounded-[28px] flex items-center justify-center text-primary mb-8 group-hover:scale-110 transition-transform duration-500 shadow-premium-soft">
                            <Palette size={32} />
                        </div>
                        <h3 className="text-2xl mb-4 font-black text-slate-900 display-font">100% Intervenidas</h3>
                        <p className="text-slate-400 font-medium leading-relaxed">Cada pieza es pintada a mano, asegurando que no existan dos iguales.</p>
                    </div>
                    <div className="flex flex-col items-center group">
                        <div className="w-20 h-20 bg-secondary/10 rounded-[28px] flex items-center justify-center text-secondary mb-8 group-hover:scale-110 transition-transform duration-500 shadow-premium-soft">
                            <ShieldCheck size={32} />
                        </div>
                        <h3 className="text-2xl mb-4 font-black" style={{ color: 'var(--secondary)' }}>Calidad Premium</h3>
                        <p className="text-slate-400 font-medium leading-relaxed">Utilizamos lacas y selladores de alta resistencia para exterior.</p>
                    </div>
                    <div className="flex flex-col items-center group">
                        <div className="w-20 h-20 bg-slate-100 rounded-[28px] flex items-center justify-center text-slate-600 mb-8 group-hover:scale-110 transition-transform duration-500 shadow-premium-soft">
                            <MapPin size={32} />
                        </div>
                        <h3 className="text-2xl mb-4 font-black text-slate-900 display-font">Envíos y Retiros</h3>
                        <p className="text-slate-400 font-medium leading-relaxed">{settings.shippingInfo}</p>
                    </div>
                </div>
            </section>

            {/* Artisan Separator */}
            <section className="py-16 bg-terracotta-soft/20 overflow-hidden border-b border-terracotta/5 relative">
                <div className="absolute inset-0 opacity-[0.03] pointer-events-none" style={{ backgroundImage: 'radial-gradient(var(--terracotta) 0.5px, transparent 0.5px)', backgroundSize: '24px 24px' }} />
                <div className="flex whitespace-nowrap items-center gap-12 md:gap-24 opacity-40 overflow-hidden">
                    <div className="flex animate-marquee items-center gap-12 md:gap-24 shrink-0">
                        {[1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
                            <div key={i} className="flex items-center gap-8 md:gap-16">
                                <span className="text-terracotta font-serif text-xl md:text-2xl tracking-[0.2em] uppercase">Diseño de Autor</span>
                                <div className="w-2 h-2 rounded-full bg-terracotta/30" />
                                <span className="text-terracotta font-serif text-xl md:text-2xl tracking-[0.2em] uppercase">100% Hecho a Mano</span>
                                <div className="w-2 h-2 rounded-full bg-terracotta/30" />
                                <span className="text-terracotta font-serif text-xl md:text-2xl tracking-[0.2em] uppercase">Intervenciones Únicas</span>
                                <div className="w-2 h-2 rounded-full bg-terracotta/30" />
                            </div>
                        ))}
                    </div>
            ...
            {/* Store Section */}
            <section id="tienda" className="py-32 bg-[#fdfaf6]">
                <div className="container mx-auto px-6">
                    <div className="flex flex-col gap-6 mb-20">
                        <span className="text-primary font-black text-xs uppercase tracking-[0.3em] block">NUESTRAS PIEZAS</span>
                        <h2 className="text-6xl md:text-8xl text-slate-900 display-font leading-none tracking-tight">La Tienda</h2>
                        <p className="text-slate-400 text-xl font-medium italic max-w-xl">Explora nuestra colección de objetos con alma para transformar tus rincones favoritos.</p>
                    </div>
