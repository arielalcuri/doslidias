                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                                    <div className="glass-card p-12 space-y-10">
                                        ...
                                        <div className="space-y-8">
                                            ...
                                            <FormGroup label="Imagen Hero Desktop (URL)">
                                                <input className="admin-input font-mono text-xs" value={tempSettings.heroImage} onChange={e => setTempSettings({ ...tempSettings, heroImage: e.target.value })} />
                                            </FormGroup>
                                        </div>
                                    </div>
